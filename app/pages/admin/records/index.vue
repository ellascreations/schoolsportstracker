  ...
  <main class="mx-auto max-w-7xl px-4 py-8">
    ...
    <form class="mt-6 rounded-xl border bg-white p-6 shadow-sm" @submit.prevent="submit">
      ...
      <div class="mt-5 grid gap-4 md:grid-cols-3">
        <label><span class="mb-1 block text-sm font-semibold">Record scope</span><select v-model="form.record_scope" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"><option value="school">School</option><option value="house">House</option><option v-if="profile?.role==='super_admin'" value="interschool">Interschool</option></select></label>
        <label v-if="form.record_scope!=='interschool'"><span class="mb-1 block text-sm font-semibold">School</span><select v-model.number="form.school_id" :disabled="profile?.role!=='super_admin'" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30 disabled:bg-slate-900 disabled:text-slate-400"><option v-for="school in schools" :key="school.id" :value="school.id">{{school.name}}</option></select></label>
        <label v-if="form.record_scope==='house'"><span class="mb-1 block text-sm font-semibold">House</span><select v-model.number="form.house_id" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"><option :value="null">Select house</option><option v-for="house in houses" :key="house.id" :value="house.id">{{house.name}}</option></select></label>

        <label><span class="mb-1 block text-sm font-semibold">Sport / event</span><select v-model.number="form.sport_id" required class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"><option :value="null">Select sport</option><option v-for="sport in sports" :key="sport.id" :value="sport.id">{{sport.category}} — {{sport.name}}</option></select></label>
        <label><span class="mb-1 block text-sm font-semibold">Year level</span><select v-model.number="form.year_level" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"><option :value="null">Open</option><option v-for="y in 12" :key="y" :value="y">Year {{y}}</option></select></label>
        <label><span class="mb-1 block text-sm font-semibold">Category</span><select v-model="form.gender" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"><option value="female">Girls</option><option value="male">Boys</option><option value="mixed">Mixed</option><option value="open">Open</option></select></label>

        <label><span class="mb-1 block text-sm font-semibold">Athlete name</span><input v-model="form.holder_name" required class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30" /></label>
        <label v-if="form.record_scope==='interschool'"><span class="mb-1 block text-sm font-semibold">Athlete school</span><input v-model="form.holder_school_name" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30" /></label>
        <label><span class="mb-1 block text-sm font-semibold">Result value</span><input v-model="form.result_value" required inputmode="decimal" placeholder="e.g. 11.42, 1:04.33 or 4.92" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30" /></label>
        <label><span class="mb-1 block text-sm font-semibold">Display result (optional)</span><input v-model="form.result_display" placeholder="e.g. 11.42 s" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30" /></label>
        <label><span class="mb-1 block text-sm font-semibold">Date achieved</span><input v-model="form.achieved_date" type="date" required class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30" /></label>
        <label class="md:col-span-3"><span class="mb-1 block text-sm font-semibold">Notes</span><input v-model="form.notes" placeholder="Optional historical source or notes" class="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30" /></label>
      </div>
