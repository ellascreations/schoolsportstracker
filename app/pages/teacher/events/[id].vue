...
const route=useRoute(); const supabase=useSupabaseClient(); const event=ref<any>(null); const participants=ref<any[]>([]); const message=ref(''); const errorMessage=ref(''); const saving=ref(false)
