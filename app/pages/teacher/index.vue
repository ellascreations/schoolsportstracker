  ...
  >
    ...
    >
      <div>
        ...
        <h1
          class="mt-1 text-3xl font-bold text-white"
        >
          Event Management
        </h1>
      ...
      <NuxtLink
        ...
        to="/admin/events"
        class="rounded-lg border border-slate-600 bg-slate-900 px-4 py-2 text-sm font-semibold text-slate-100 hover:bg-slate-800"
      >
        Admin Events
      </NuxtLink>
    </div>
    ...
    <section
      v-if="loading"
      class="rounded-xl border border-slate-700 bg-slate-900 p-10 text-center shadow-sm"
    >
      <div
    ...
    >
      <NuxtLink
        ...
        class="rounded-xl border border-slate-700 bg-slate-900 p-5 shadow-sm transition hover:border-emerald-500/60 hover:bg-slate-800/80 hover:shadow-lg"
      >
        <div
        ...
        >
          ...
          <span
            class="rounded-full border border-slate-600 bg-slate-800 px-2.5 py-1 text-xs font-bold capitalize text-slate-300"
          >
            {{
              String(
                event.status || ''
        ...
        <div
          class="mt-4 grid gap-2 text-sm text-slate-300 sm:grid-cols-2"
        >
          <div>
        ...
        <div
          class="mt-4 text-sm font-semibold text-emerald-400"
        >
          Open Result Entry →
        </div>
      </NuxtLink>
